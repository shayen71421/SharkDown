...
export const Route = createFileRoute("/dashboard")({
  head: () => ({
    meta: [
      { title: "Dashboard — SharkDown" },
      { name: "description", content: "Browse your GitHub repositories." },
    ],
  }),
...
function RepoCard({ repo }: { repo: RepoInfo }) {
  return (
    <Link
      ...
      className="group rounded-xl border border-border bg-surface p-5 transition hover:border-primary/30 hover:bg-surface-elevated"
    >
      <div className="mb-3 flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          <h3 className="truncate font-display text-base font-semibold group-hover:text-primary-glow transition-colors">
            {repo.name}
          </h3>
          {repo.description && (
